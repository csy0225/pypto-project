...
多个 blocker 压成一个“根因”。长时间、多 session 的实践案例入口见
`references/n1-case-study.md`；按需加载时间线、因果链、stall 定位和设计准入
reference，不要默认读取所有历史材料。
...
详细实践从 [案例入口](references/n1-case-study.md) 开始，并按任务直接加载：

| 类别 | Reference |
|---|---|
| 时间线 | [总览](references/n1-timeline.md)、[早期前史](references/n1-timeline-early.md)、[单程序 bring-up](references/n1-timeline-bringup.md)、[精度主线](references/n1-timeline-precision.md)、[stall/release](references/n1-timeline-stall-release.md)、[因果链](references/n1-causal-chains.md) |
| 排障 | [导航](references/n1-debugging-playbook.md)、[stall 定位](references/n1-stall-localization.md)、[设计审计/A-B](references/n1-design-audit.md)、[发布验证](references/n1-release-validation.md) |
| 新项目 | [准入导航](references/n1-project-admission.md)、[设计 Gate 0～5](references/n1-design-admission-gates.md)、[实现/发布 Gate 6～10](references/n1-implementation-release-gates.md)、[Day 0 模板](references/n1-project-day0-template.md) |
| 证据 | [原始证据索引](references/n1-evidence-index.md) |

项目准入标准不是 active prompt；它要求编码前冻结 canonical object、layer/index、
buffer、通信、native W8A8、生成器、可观测性和 validation ladder。
...
```text
machine scope: 0162 = release-qualified / evidence path

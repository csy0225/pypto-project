...
|------|------|-------|-----------|---------|--------------|---------------------|-----------|
| 2026-07-05 | backend↔co-resident-worker code path 完成（BE 协议 + layer targeting，selftest bad=0） | `stepfun/develop:b00c8b23` | `stepfun/develop:bdcb1b7`（pypto_moe_backend co-resident 协议；已推送 fork） | `stepfun/develop:e25732f0` | `stepfun/develop:da011a3d` | `c66b4120` | `v0.45` |

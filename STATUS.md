...
| 仓库 | 分支/用途 | Commit | 备注 |
|------|-----------|--------|------|
| `pypto-lib` | `stepfun/develop` | `9718083` | 新增 vLLM monkey patch skeleton；weight contract `0511d27`，config-align `e616407` |
...
|------|------|-------|-----------|---------|--------------|---------------------|-----------|
| 2026-06-26 | W8A8 prefill PASS + Phase20 config/weight/monkey-patch surface 启动 | `stepfun/develop:b00c8b23` | `stepfun/develop:9718083`（vLLM monkey patch skeleton；weight_translate `0511d27`；config-align `e616407`） | `stepfun/develop:e25732f0` | `stepfun/develop:da011a3d` | `c66b4120` | `v0.45` |

...
>
> - **验证记录**（step 1-5 device 实测证据）：[`../phases/23-zero-copy-kv-ipc-validation.md`](../archive/completed-phases/23-zero-copy-kv-ipc-validation.md)
> - **执行 plan**（step 6/7 落地）：Phase 24 / 25 / 26（见 phases/23 §5、[`../planning/phases/README.md`](../planning/phases/README.md)）
> - **执行模型上限对比**：[`aclgraph-vs-pypto-execution-model.md`](aclgraph-vs-pypto.md)

...
> - 关联 Phase:[`../phases/20-vllm-backend-monkey-patch.md`](../phases/20-vllm-backend-monkey-patch.md)、[`../phases/22-perf-baseline.md`](../phases/22-perf-baseline.md)
> - 关联 arch:[`vllm-step3p5-mapping.md`](vllm-step3p5-mapping.md)(op-级映射)
...
- [`../phases/20-vllm-backend-monkey-patch.md`](../phases/20-vllm-backend-monkey-patch.md) — 整模型 monkey-patch(D1 whole-model patch、D2 comm option A、mixed-mode MoE)
- [`../phases/22-perf-baseline.md`](../phases/22-perf-baseline.md) — perf baseline + swimlane / PMU 采点
- [`vllm-step3p5-mapping.md`](vllm-step3p5-mapping.md) — `Step3p5Model` ↔ `decode_fwd` op-级映射

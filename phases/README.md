...
| **27** | N=1 整网融合（单 @pl.program 全 45 层 + tail） | ✅ **standalone canonical P42 完成**：0162 pull+pull 20/20、每次 `argmax=303`，pypto-lib `0e7a0fdd` | [27-n1-whole-net-fusion.md](27-n1-whole-net-fusion.md) |
| **28** | N=1 整网 → vLLM live single-handoff 集成 | 🟡 standalone gate 已清；per-layer KV bridge、redundant-weight/3-way HBM、live token-exact A/B 仍待完成 | [28-n1-live-integration.md](28-n1-live-integration.md) |

...
> [`../architecture/aclgraph-vs-pypto-execution-model.md`](../../reference/aclgraph-vs-pypto.md)、
> [`../deployment/troubleshooting-8001-pypto-bridge.md`](../../postmortems/11-8001-bridge-live-ops.md)。
